#!/bin/bash
# Rebuild correct index.html with all games
    ...
    <header class="gradient-bg text-white py-12 px-4">
        <div class="max-w-7xl mx-auto">
            <div class="text-center">
                ...
                <p class="text-lg md:text-xl opacity-90 font-light">精选休闲小游戏，随时随地轻松娱乐</p>
...
>>>>>>> 3303adb (feat: add countdown-eliminate - reaction click when zero game - closes #22)
...
"滑动方格将数字按顺序排列，支持多种尺寸。"
"控制挡板接住下落的球，球越快得分越高。"
"✏️ 从起点绘制路径到终点，不能交叉重复，填满所有格子即可通关。"
...
"六边形网格种花，相邻相同自动合并升级，治愈解压休闲游戏。"
<<<<<<< HEAD
"传统克朗代克接龙，每完成一个花色点亮像素，完成后保存分享像素作品。"
=======
"传统克朗代克接龙，每完成一个花色点亮像素，完成后保存分享你的像素作品。"
"六边形网格种花，相邻相同自动合并升级，治愈解压休闲游戏。"
>>>>>>> 3303adb (feat: add countdown-eliminate - reaction click when zero game - closes #22)
"把切碎的水果拼回去，拖动碎片还原完整水果，难度递进考验眼力。"
...
=======
"控制小点躲避蔓延颜料洪水填充，存活越久分数越高。"
"画布绘画词语 AI 识别猜词，单人闯关多人对战分享，不用后端。"
"数字归零才能点击消灭，考验你的瞬间反应速度，难度逐渐递增升级。"
)
>>>>>>> 3303adb (feat: add countdown-eliminate - reaction click when zero game - closes #22)
